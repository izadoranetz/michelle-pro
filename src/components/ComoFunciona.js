        ...
        <div className="row justify-content-evenly flex-wrap">
          ...
          >
            ...
            <div className={styles.cardComoFuncionaImagem}>
              <img src={imgItem1} alt="Foto criança brincando com carrinhos" />
            </div>
          ...
          >
            ...
            <div className={`${styles.cardComoFuncionaTitulo} ${styles.azul}`}>
            ...
            <div className={styles.cardComoFuncionaTextos}>
              Objetivos desenvolvidos para serem adquiridos num período médio de
              12 semanas. A meta é definida e adaptada durante as semanas pela
              supervisora do caso.
            </div>
          </div>
          ...
          >
            ...
            <div className={styles.cardComoFuncionaTextos}>
              ...
              próximo plano terapêutico. Novos objetivos serão estabelecidos ou
              os antigos serão revistos.
            </div>
          </div>
        </div>
      </div>
